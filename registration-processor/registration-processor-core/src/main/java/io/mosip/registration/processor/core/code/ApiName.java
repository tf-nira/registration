...
public enum ApiName {
	...
	IDREPOUPDATEDRAFT,
	IDREPOPUBLISHDRAFT,
	IDREPOEXTRACTBIOMETRICS, LEGACYAPI, PACKETMANAGER_CREATE_PACKET, MIGARTION_URL, MIGARTION_URL_NEW, MIGARTION_PACKET_CREATION,
	SECURE_ZONE_URL, GET_CERTIFICATE, IDREPODISCARDDRAFT, GETPRNSTATUS, CHECKTRANSLOGS, CONSUMEPRN, IDREPOUPDATEIDENTITY;
