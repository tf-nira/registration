...
public class AgeGroupTagGeneratorTest {
	...
	public void testGenerateTagsForChildGroup() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenReturn(17.0);
	...
	public void testGenerateTagsForAdultGroup() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenReturn(30.0);
		Map<String, String> tags = ageGroupTagGenerator.generateTags("1234", "123", "NEW", null, null, 0);
	...
	public void testGenerateTagsForSeniorCitizenGroup() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenReturn(65.0);
		Map<String, String> tags = ageGroupTagGenerator.generateTags("1234", "123", "NEW", null, null, 0);
	...
	public void testGenerateTagsForLostPacket() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenReturn(-1.0);
	...
	public void testGenerateTagsForAgeGroupNotFound() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenReturn(201.0);
	...
	public void testGenerateTagsForUtilityThrowningIOException() throws Exception {
		Mockito.when(utility.getApplicantAgeInDouble(anyString(), anyString(), any())).thenThrow(new IOException());
